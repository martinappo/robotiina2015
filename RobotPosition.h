...
private:
	...
	bool isRobotAboveCenterLine(int yellowGoalAngle, int blueGoalAngle);
	int getRobotDirection(int yellowGoalDist, int yellowGoalAngle, int blueGoalDist, int blueGoalAngle);
};
