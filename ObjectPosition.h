...
public:
	...
	virtual void updateRawCoordinates(const cv::Point2d pos, cv::Point2d orgin = cv::Point2d(0, 0), bool useKalman = false); // Takes raw coordinates of object from frame
